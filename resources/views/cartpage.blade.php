        ...
        <div class="cart-grid">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product-info">
                                        ...
                                        @else
                                            <div
                                                class="product-img d-flex align-items-center justify-content-center bg-light">
                                ...
                                <td>
                                    <div class="qty-controls">
                                        <a href="{{ route('cart.decrease', $item->product->id) }}"
                                            class="btn btn-danger">-</a>
                                        <span class="qty-val">{{ $item->quantity }}</span>
                                        <a href="{{ route('cart.increase', $item->product->id) }}"
                                ...
                                <!-- Remove -->
                                <td>
                                    <a href="{{ route('cart.remove', $item->product->id) }}" class="remove-btn"
            ...
            @php
                ...
                foreach ($cartItems as $item) {
                    $total += $item->total; // already per item subtotal
                }
            @endphp
